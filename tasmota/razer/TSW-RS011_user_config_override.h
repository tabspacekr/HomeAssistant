...
#define PROJECT                "TSW-RS011" 
#define DEVICE_NAME          "Razer Motion Sensor TSW-RS011" 
#define FRIENDLY_NAME          "Razer Motion Sensor" 
#define NTP_SERVER1            "pool.ntp.org" 
#define APP_TIMEZONE           9
#define USER_TEMPLATE "{\"NAME\":\"TabSpace Razer Motion Sensor\",\"GPIO\":[256,1,1,1,1,160,1,1,1,1,1,1,1,1],\"FLAG\":0,\"BASE\":18}"
#define MODULE USER_MODULE
#define USER_RULE1 "on switch1#state do publish stat/%topic%/MOTION value endon" 
#define USER_RULE2 "on system#boot do publish2 homeassistant/binary_sensor/TSW-RS011_%deviceid%/config {\"name\":\"Razer Motion Sensor\",\"state_topic\":\"stat/%topic%/MOTION\",\"payload_on\":1,\"payload_off\":0,\"availability_topic\":\"tele/%topic%/LWT\",\"payload_available\":\"Online\",\"payload_not_available\":\"Offline\",\"device_class\":\"motion\",\"force_update\":true,\"unique_id\":\"TSW-RS011_%deviceid%\",\"device\":{\"name\":\"Razer Motion Sensor\",\"manufacturer\":\"TabSpace\",\"model\":\"TSW-RS011\",\"identifiers\":[\"%deviceid%\"]}} endon" 
#define USER_BACKLOG "Rule1 1; Rule2 1; switchmode 1; so19 1" 
#endif
