...
ha_entity = config.get("HA","ha_entity") # alarm_control_panel 뒷부분만 입력
...
while True:
    ...
    # ha_lock_state : disarmed (항시개방), armed_away(경비중-카드긁으면문열림), armed_custom_bypass(경비중-카드키반응안함)
